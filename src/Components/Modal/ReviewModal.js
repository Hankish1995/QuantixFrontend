...
function ReviewModal() {
  ...
  return (
    <>
      ...
      <Modal size={"lg"} show={show} onHide={handleClose} className="reviewModal_outer">
      ...
      <h3 className='large_font'>Review Report</h3>
        ...
        <Modal.Body>
            <div>
                ...
                <p className='cmn_small_heading'>Lorem ipsum dolor sit amet consectetur. Libero velit 
                    egestas pellentesque dolor mi quis augue elementum.</p>
            </div>
            <div>
